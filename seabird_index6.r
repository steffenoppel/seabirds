...
rm(remainIDs,KDE.Sp,va90b,olInd,OL1,va90a,KDE.Surface,TripCoords,DataGroup,KDE.Wgs,Tbl,KDE.Spdf,vaSP, stepincrease,mergedpol,startpolygon,selinds, stepINDS)
gc(verbose = F)
return(outlist)
